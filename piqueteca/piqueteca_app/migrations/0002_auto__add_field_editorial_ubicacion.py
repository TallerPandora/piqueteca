...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Editorial.ubicacion'
        db.add_column(u'piqueteca_app_editorial', 'ubicacion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Editorial.ubicacion'
        db.delete_column(u'piqueteca_app_editorial', 'ubicacion')
